  ...
  useEffect(() => {
    const fetchSalespeople = async () => {
      try {
        ...
        // 过滤出销售角色的用户
        const salesUsers = Array.isArray(data.users) 
          ? data.users.filter((user: User) => user.role === 'SALES' || user.role === 'MANAGER')
          : [];
        setSalespeople(salesUsers);
      } catch (err) {
        setError(err instanceof Error ? err.message : 'Failed to load sales users');
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold mt-4">Create New Customer</h1>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                {loading ? (
                  <div className="text-gray-500">Loading salespeople...</div>
                ) : (
                  <select
                    id="salespersonId"
                    name="salespersonId"
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                  placeholder="Enter customer requirements or additional notes"
                />
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 flex items-center justify-end">
            ...
            >
              {saving ? (
                ...
                <>
                  <FiSave className="mr-2" /> Create Customer
                </>
              )}
            </button>
          </div>
